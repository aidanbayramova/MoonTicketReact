          ...
          <div className="info-cards">
            <div className="info-card">
              ...
              <div className="info-content">
                ...
                <span className="info-value">{movie.location}</span>
              </div>
            </div>
            ...
            <div className="info-card">
              ...
              <div className="info-content">
                ...
                <span className="info-value">{movie.fromDate} – {movie.toDate}</span>
              </div>
            </div>
            ...
            <div className="info-card">
              ...
              <div className="info-content">
                ...
                <span className="info-value">{movie.age}</span>
              </div>
            </div>
              ...
              <div className="seats-container">
                {Array.from({ length: rowData.seats }, (_, i) => {
                  ...
                  return (
                    <div
                      key={seatId}
                      className={`cinema-seat ${rowData.type} 
                        ${isSelected ? "selected" : ""}
                        ${isOccupied ? "occupied" : ""}
                      `}
