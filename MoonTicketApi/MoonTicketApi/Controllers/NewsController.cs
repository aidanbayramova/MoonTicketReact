...
namespace MoonTicketApi.Controllers
{
    ...
    public class NewsController : ControllerBase
    {
        ...
        public async Task<ActionResult<NewsDto>> Create([FromForm] NewsCreateDto dto)
        {
        ...
        [HttpPut("{id}")]
        [Consumes("multipart/form-data")]
        public async Task<IActionResult> Edit(int id, [FromForm] NewsEditDto dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            ...
            try
            {
                await _newsService.EditAsync(dto, id);
                return NoContent();
            }
